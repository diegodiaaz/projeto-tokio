...
public class DadosMotoGUI {
	...
	private void initialize() {
		...
		frameDadosMoto.setIconImage(Toolkit.getDefaultToolkit()
				.getImage(DadosMotoGUI.class.getResource("/br/com/tokio/images/logo_tokio.png")));
		...
		panel_1.add(lblNewLabel_2_3_3_1);
				...
				btnAdicionarMoto.setBounds(403, 346, 146, 43);
		...
		labelGradiente
				.setIcon(new ImageIcon(DadosMotoGUI.class.getResource("/br/com/tokio/images/fundo_login_maior.png")));
