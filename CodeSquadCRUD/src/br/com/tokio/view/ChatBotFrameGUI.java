...
public class ChatBotFrameGUI {
	...
	public ChatBotFrameGUI() {
		initialize();
	}

	private void initialize() {
		frameChat = new JFrame();
		frameChat.setForeground(new Color(0, 153, 102));
		frameChat.setFont(new Font("Arial", Font.BOLD, 15));
		frameChat.setIconImage(Toolkit.getDefaultToolkit()
				.getImage(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/logo_tokio.png")));
		frameChat.setTitle("TOKIO MARINE SEGURADORA");
		frameChat.setBounds(100, 100, 1000, 600);
		...
		frameChat.getContentPane().add(panel);
		panel.setLayout(null);
		
		JButton botaoAreaDoCliente = new JButton("");
		botaoAreaDoCliente.setIcon(new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/BotaoAreaCliente1.png")));
		botaoAreaDoCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				LoginUsuarioGUI loginUsu = new LoginUsuarioGUI();
				loginUsu.frameUsuario.setVisible(true);
				frameChat.dispose();
		...
		labelMarinaImagem.setIcon(new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/marinonanona.png")));
		labelMarinaImagem.setBounds(20, 63, 277, 442);
		panel.add(labelMarinaImagem);
		botaoAreaDoCliente.setBounds(252, 520, 183, 30);
		panel.add(botaoAreaDoCliente);
		...
		botaoAjuda.setIcon(new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/botao_ajuda.png")));
		botaoAjuda.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				String caminho = "C:/Users/SCCP1910/Downloads/01-aula-inaugural%20POO.pdf";
		...
		botaoAreaCorretor
				.setIcon(new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/BOTAO_CORRETOR.png")));
		...
		botaoAreaCorretor.setBounds(59, 520, 183, 30);
		...
		botaoEnviarMensagem
				.setIcon(new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/botao_enviar.png")));
		botaoEnviarMensagem.setBounds(942, 520, 32, 30);
		panel.add(botaoEnviarMensagem);

		JLabel labelMensagemMarina = new JLabel(
				"Olá, eu sou a Marina e vou te ajudar na cotação e na contratação do seu seguro!");
		labelMensagemMarina.setForeground(Color.WHITE);
		labelMensagemMarina.setFont(new Font("Arial", Font.BOLD, 18));
		labelMensagemMarina.setBounds(214, 15, 740, 59);
		panel.add(labelMensagemMarina);

		JLabel labelFundoGradient = new JLabel("");
		labelFundoGradient.setIcon(
				new ImageIcon(ChatBotFrameGUI.class.getResource("/br/com/tokio/images/fundo_login_maior.png")));
